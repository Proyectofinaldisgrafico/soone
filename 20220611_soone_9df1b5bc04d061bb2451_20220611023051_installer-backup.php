...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220611_soone_9df1b5bc04d061bb2451_20220611023051_archive.zip';
	const ARCHIVE_SIZE		 = '84608047';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '9df1b5b-11023051';
    const SECONDARY_PACKAGE_HASH = 'f8cbc5a-11023051';
	const VERSION			 = '1.4.6';
